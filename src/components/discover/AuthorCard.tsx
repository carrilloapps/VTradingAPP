...
const AuthorCard = ({ author }: AuthorCardProps) => {
  ...
  const statsTextStyle = [styles.statsText, { color: theme.colors.primary }];
      ...
      <View style={styles.socialRow}>
        ...
        {author.social?.instagram && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.instagram)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.linkedin && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.linkedin)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.youtube && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.youtube)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.tiktok && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.tiktok)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.website && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.website)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.github && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.github)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.pinterest && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.pinterest)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.soundcloud && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.soundcloud)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.tumblr && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.tumblr)}
            style={styles.socialIcon}
          />
        )}
        {author.social?.wikipedia && (
          <IconButton
            ...
            mode="contained-tonal"
            size={20}
            onPress={() => handleSocialPress(author.social.wikipedia)}
            style={styles.socialIcon}
          />
        )}
      </View>
