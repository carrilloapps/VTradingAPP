            ...
            <Tooltip title="Variación respecto a tasa BCV">
                ...
                >
                    <View style={badgeStyle}>
                        ...
                        <MaterialCommunityIcons name="information-outline" size={10} color={color} style={styles.infoIcon} />
                    </View>
                </TouchableOpacity>
            </Tooltip>
        );
                ...
                <View style={styles.header}>
                    ...
                    {lastUpdated && (
                        <View style={[styles.dateBadge, { backgroundColor: theme.colors.elevation.level2 }]}>
                            <MaterialCommunityIcons name="clock-outline" size={12} color={theme.colors.onSurfaceVariant} style={styles.clockIcon} />
