        ...
        <View style={styles.container}>
            ...
            <View style={styles.swapContainer}>
                <View style={styles.rateDisplay}>
                    <Text variant="bodySmall" style={[styles.rateLabel, { color: theme.colors.onSurfaceVariant }]}>
                        1 {fromCurrency?.code} ≈ <Text style={[styles.rateText, { color: theme.colors.onSurface }]}>{exchangeRate}</Text> {toCurrency?.code}
                    </Text>
                </View>
                <IconButton
                    icon="swap-vertical"
