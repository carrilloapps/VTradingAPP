    ...
    return (
        <View style={styles.section}>
            <View style={styles.sectionHeader}>
                <Text variant="headlineSmall" style={[styles.titleMedium, { color: theme.colors.onSurface }]}>
                    Mercado Bursátil
                </Text>
                <TouchableOpacity
                ...
                >
                    <Text variant="labelLarge" style={[styles.seeAllText, { color: theme.colors.primary }]}>VER TODO</Text>
                </TouchableOpacity>
            </View>
