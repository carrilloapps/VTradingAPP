    ...
    return (
        ...
        >
            <View style={styles.avatarContainer}>
                ...
                <View style={[styles.statusDot, { backgroundColor: colors.success, borderColor: theme.colors.background }]} />
            </View>

            <View style={styles.textContainer}>
                <Text style={[styles.subtitle, { color: isPremium ? colors.warning : theme.colors.onSurfaceVariant }, isPremium ? styles.boldText : styles.normalText]}>
