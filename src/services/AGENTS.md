...
- **Lógica de Negocio Centralizada:** Implementa `getAvailableTargetRates` para validar pares de conversión:
  ...
  2.  **Fiat (BCV):** -> VES/Bs o Cripto (incluyendo Stablecoins). _Permite comparar oficial vs mercado digital._
  3.  **Frontera (Border):** -> VES/Bs o Stablecoins. _Evita pares ilógicos como COP->USD._
